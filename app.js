...
};let R=[],C=null,O={backdrop:"auto",layout:"auto",eero:null,mobile:null,sym:null,plans:{},design:{speedSize:30,scheduleSize:11,priceSize:44,rowGap:6,planY:210,promoY:525}};const $=x=>document.getElementById(x),E=v=>String(v??"").replace(/[&<>"]/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"}[c]));
